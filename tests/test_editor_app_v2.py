...
class TestEditorAppV2Template(unittest.TestCase):
    ...
    def test_editor_app_uses_ksy_m_field_names(self) -> None:
        ...
        self.assertIn("receiveButton.textContent = '加入已有据点'", html)
        ...
        self.assertIn("if (houseAttr === 0) return '城池';", html)
        self.assertIn("if (houseAttr === 1) return '军寨';", html)
        self.assertIn("if (houseAttr === 2) return '山寨';", html)
        self.assertIn("if (kind === 'site') {", html)
        self.assertIn("SITE_INI_FIELDS.includes(change.field)", html)
        self.assertIn("{ value: '0', label: '城池' }", html)
        ...
        self.assertIn('统御', html)
        self.assertIn('城池', html)
    ...
    def test_editor_app_preserves_manager_state_and_derives_relations(self) -> None:
        ...
        self.assertIn('function newSiteDefaults()', html)
        self.assertIn('castle_scale: 1', html)
        self.assertIn('population: 1200', html)
        self.assertIn('gold: 3000', html)
        self.assertIn('food: 7500', html)
        self.assertIn('develop: 40', html)
        self.assertIn('commerce: 40', html)
        self.assertIn('security: 50', html)
